          ...
          <div className="relative z-10 mx-auto flex min-h-screen max-w-5xl flex-col items-center justify-center gap-8 px-6 text-center md:gap-12">
            <div className="space-y-6 sm:-translate-y-10 md:-translate-y-16 lg:-translate-y-24 transition-transform duration-500">
              ...
              <h2 className="text-3xl font-semibold md:text-5xl">
                Yeah, so the first step is you upload your product image, and in the second step, you can clean your product image, and in the third step, you have your prompt, your style, and the AI generates a storyboard for you, and in the final step, you can generate your video.
              </h2>
                      ...
                      <div className="flex flex-wrap items-center gap-2">
                        {steps.map((step, index) => (
                          <button
                            ...
                            className={`inline-flex items-center gap-2 rounded-full border px-3 py-1 text-xs uppercase tracking-[0.28em] transition ${
                              activeIndex === index
